...
<tr>
<td class="top0" colspan=2 >MY INFO EDIT</td>
</tr>
<tr>
...
<tr>
	<td class="info" colspan="2" align="center"><input type="submit" name="submit" value=" UPDATE " style="font-size:12pt; border-radius: 5px;color:white;background-color:rgb(75,174,138);"> </td>
</tr>
</table>
</form>
</body>
