...
<div style="background-color:ghostwhite; color:black; WIDTH: 100%; HEIGHT: 100%">
	...
	<div style="background-color:white; padding: 30px; margin: 3em auto; width:600px; border-radius:10px;border:2px solid darkgray;">
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
<table border="0" width="600" >


<tr>
	<td align="center" height="200"> <p style="font-size:20px; font-family: sans-serif;color:red;">REQUIRED</p> </td>
	<td colspan="2">
	<div class="item"><b>Student ID : </b></div><input type="text" name="id" onkeyup="showHint(this.value)"> <a id="txtHint"></a>
	<br/><br/>
	<div class="item"><b>Password : </b></div> <input type="password" name="pass" >
	<br/><br/>
	<div class="item"><b>Name : </b></div> <input type="text" name="name" >
	<br/><br/>
	<div class="item"><b>Email : </b></div><input type="text" name="email" > <br> <br><hr/>
	</td>
</tr>

<tr>
	<td align="center" height="200"> <p style="font-family: sans-serif;font-size:20px">OPTIONAL</p> </td>
	<td colspan="2">
...
<tr>
	...
	<hr/><br><br><input type="submit" name="submit" value=" Registration " style=font-size:15pt; background-color:gray;>
	</td>
</tr>
